...
public sealed class MatchProbeDecode
{
    ...
    public static string FormatC2(byte c2) => c2 switch
    {
        ...
        MatchC2States.RoundEnd => "HalfTimeIntro(111) / RankedDefuse round-end id",
        MatchC2States.HalfTimeSwap => "HalfTimeSwap(112) swapped_team+score flip",
        MatchC2States.HalfTimeTransition => "HalfTimeTransition(113)",
